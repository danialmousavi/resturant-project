...
import { clearCart, decrement, increment, removeFromCart } from "@/utils/redux/slices/cartSlice";
                                                ...
                                                <tbody>
                                                    {state.cart.map(item => (
                                                        <tr key={item.id}>
                                                                ...
                                                                <div>
                                                                    {item.is_sale ? (
                                                                        <>
                                                                            ...
                                                                            <del className="me-1">{item.price.toLocaleString()}</del>
                                                                        </>
                                                                    ) : (
                                                            ...
                                                            <td>
                                                                {item.is_sale ? (
                                                                    <span>{(item.sale_price * item.qty).toLocaleString()}</span>
